About airflow-common-operators-feedstock
========================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/airflow-common-operators-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/airflow-common-operators-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add airflow-common-operators
# for installing globally
pixi global install airflow-common-operators
```
...
It is possible to list all of the versions of `airflow-common-operators` available on your platform:
...
```
pixi search airflow-common-operators --channel conda-forge
```
